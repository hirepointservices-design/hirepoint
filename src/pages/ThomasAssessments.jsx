    ...
    <section className="w-full">
      ...
      */}
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 leading-relaxed text-slate-800">
        ...
        <h2 className="text-2xl font-bold mt-16 mb-4 text-[var(--HirePoint-teal)]">
          2. General Intelligence Assessment (GIA)
        </h2>
        ...
        <p className="font-semibold mt-4">Note:</p>
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>A) Administering GIA Test + Soft Copy Report – <strong>₹3999 + GST</strong></li>
          <li>B) Interpretation + One-to-One Coaching – <strong>₹2500 + GST</strong></li>
        </ul>
        ...
        <h2 className="text-2xl font-bold mt-16 mb-4 text-[var(--HirePoint-teal)]">
          3. High Potential Trait Indicator (HPTI)
        </h2>
        ...
        <p className="font-semibold mt-4">Note:</p>
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>A) Administering HPTI Test + Soft Copy Report – <strong>₹7500 + GST</strong></li>
          <li>B) Interpretation + One-to-One Coaching – <strong>₹5000 + GST</strong></li>
        </ul>
        ...
        <h2 className="text-2xl font-bold mt-16 mb-4 text-[var(--HirePoint-teal)]">
          4. Trait Emotional Intelligence Questionnaire (TEIQue)
        </h2>
        ...
        <p className="font-semibold mt-4">Note:</p>
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>A) Administering TEIQue Test + Soft Copy Report – <strong>₹3999 + GST</strong></li>
          <li>B) Interpretation + One-to-One Coaching – <strong>₹2500 + GST</strong></li>
        </ul>
